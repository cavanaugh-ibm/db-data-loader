...
public class CsvDataTableReader extends BaseDataTableReader {
    ...
    public Integer call() throws Exception {
        for (String fName : table.getFileNames()) {
            ...
            try {
                ...
                if (fName.startsWith(File.pathSeparator)) {
                    ...
                    csvFile = new File(config.getDefaultDirectory().getAbsolutePath() + File.separator + fName);
                }
        ...
        log.info("CSV Reader completed for " + table.getFileNames() + " - " + processed);
        return processed;
    }
